      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <Button variant="outline" className="w-full" onClick={() => setActiveTab('kuih-raya')}>
                Kuih Raya Features
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Product management features will be implemented here. This includes:
              </p>
              <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
                <li>Add/Edit/Delete products</li>
                <li>Set product categories and pricing</li>
                <li>Manage product availability</li>
                <li>Upload product images</li>
                <li>Set fulfillment lead times</li>
              </ul>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="orders" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Order management features will be implemented here. This includes:
              </p>
              <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Specialized features for Kuih Raya sellers to manage bulk orders, custom bundles, and lead times.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 border rounded">
                    <h3 className="font-semibold">Bulk Orders</h3>
                    <p className="text-sm text-muted-foreground">Manage large quantity orders</p>
                  </div>
                  <div className="p-4 border rounded">
                    <h3 className="font-semibold">Custom Bundles</h3>
                    <p className="text-sm text-muted-foreground">Create product bundles and sets</p>
                  </div>
                  <div className="p-4 border rounded">
                    <h3 className="font-semibold">Lead Time Management</h3>
                    <p className="text-sm text-muted-foreground">Set and track production deadlines</p>
                  </div>
                </div>
              </CardContent>
            </Card>
